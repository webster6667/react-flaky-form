...
var submitFlukyFormHandler = function submitFlukyFormHandler(setForm) {
  setForm(function (form) {
    ...
    if (isAllControlsValid) {
      ...
      if (initAction) {
        axios.post(initAction).then(function (data) {
...
var FlakyInput = function FlakyInput(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, errorProps), error || '')), /*#__PURE__*/React.createElement("label", _extends({
    ...
    placeholder: placeholder,
    ref: inputRef
  }, inputProps)), havePasswordVisibleSwitch ? /*#__PURE__*/React.createElement("div", {
...
export { AddControlExample, AddFormExample, FlakyForm, FlakyInput, RemoveControl, RemoveForm, useFlakyForm };
