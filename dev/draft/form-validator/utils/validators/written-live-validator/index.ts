...
export const validateWrittenData: LiveValidator = hooksData => {
  ...
  const { currentControl, newValue } = hooksData,
    ...
    {
      minValue: minValueSetting,
      maxValue: maxValueSetting,
      minLength: minLengthSetting,
      maxLength: maxLengthSetting,
      required: requiredSetting,
      number: numberSetting,
      email: emailSetting,
    } = controlValidatorsSetting as ValidatorsSettingListInsideHandler,
  ...
  if (typeof newValue === 'string' || typeof newValue === 'number') {
    ...
    if (isWrittenValueNotEmpty) {
      ...
      if (
        ...
        isLiveValidatorEnable(minValueSetting)
      ) {
      ...
      if (
        ...
        isLiveValidatorEnable(maxValueSetting)
      ) {
        errorDataHandler(errorData, {
          ...maxValueRules,
          ...maxValueSetting,
      ...
      if (
        ...
        isLiveValidatorEnable(minLengthSetting)
      ) {
        errorDataHandler(errorData, {
          ...minLengthRules,
          ...minLengthSetting,
      ...
      if (
        ...
        isLiveValidatorEnable(maxLengthSetting)
      ) {
        errorDataHandler(errorData, {
          ...maxLengthRules,
          ...maxLengthSetting,
      ...
      if (
        ...
        isLiveValidatorEnable(emailSetting)
      ) {
        errorDataHandler(errorData, {
          ...emailRules,
          ...emailSetting,
    ...
    if (
      ...
      isLiveValidatorEnable(requiredSetting)
    ) {
      errorDataHandler(errorData, {
        ...requiredRules,
        ...requiredSetting,
