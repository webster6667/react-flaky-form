import { ControlProps, ValidatorsSettingList, FormProps } from './../../types';

import {
  AddValidatorsRuleLayer,
  AddValidatorsRulesLayerToSingleControl,
...
export const addValidatorsSettingsLayer: AddValidatorsRuleLayer = (
  ...
  Object.keys(validatorsSettingsList).forEach(validatorName => {
     ...
     */
    if (isObject) {
      controlValidatorsSetting[validatorName] = {
        ...controlValidatorSettings,
        ...newValidatorSettingsLayer,
      };
    } else if (isBoolean) {
      /**
